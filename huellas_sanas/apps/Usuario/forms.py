...
def validate_username(value):
    ...
    """
    if not value.endswith('@huellassanas.cl'):
        raise forms.ValidationError('El nombre de usuario debe ser un correo electrónico con el dominio @huellassanas.cl.')
...
class EmpleadoForm(forms.ModelForm):
    ...
    username = forms.EmailField(
        ...
        required=True,
        label='Usuario (Correo Electrónico)',
        widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'usuario@huellassanas.cl'}),
