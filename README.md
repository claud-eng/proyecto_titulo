...
Guía de Instalación y Funcionamiento
    ...
    Configurar Ambiente Virtual:
		...
		Crear el ambiente virtual con el siguiente comando: python -m venv ambiente_virtual
        Navegar a la carpeta ambiente_virtual: cd ambiente_virtual 
		Navegar a la carpeta Scripts: cd Scripts
